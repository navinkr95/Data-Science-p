# -*- coding: utf-8 -*-
"""
Created on Thu Jan 27 10:00:47 2022
...
dataset = pd.read_csv(r'D:\SKILLEDGES PUNE\Datasets/50_Startups.csv')
dataset.corr()
...
#importing datasets  
data_set= pd.read_csv('D:\SKILLEDGES PUNE\Datasets/50_Startups.csv') 
