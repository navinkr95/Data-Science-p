# -*- coding: utf-8 -*-
"""
Created on Tue Feb  1 07:37:23 2022
...
#Import data 
titanic_data = pd.read_csv("D:\SKILLEDGES PUNE\Datasets/titanic.csv")
titanic_data.head(5)
titanic_data.tail(5)

print("No. of passengers in original dataset:" ,str(len(titanic_data.index)))
print("No. of passengers in original dataset:", titanic_data.shape[0])      
#Analyzing Data
